/* ===================== Schulter: Kameras, Detailansichten, Schichtstufen =====================
   ...
   detailDefs: die vier Detailfenster (id = Element-ID, title/label = i18n-Schlüssel; Markup erzeugt engine/boot.js) mit Kamera-Fit je Pose und Anzeigetext (readout).
...
const detailDefs=[
  ...
  {id:'dv2',title:'dv2',label:'dv2l',fov:26,level:4,clipX:0.55,readout:(M)=>t('ant')+' '+fmt(M.capAnt*100)+' % · '+t('post')+' '+fmt(M.capPost*100)+' %',
